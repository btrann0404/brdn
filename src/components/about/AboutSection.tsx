...
export const AboutSection = () => {
  return (
    <div className="pt-4 flex flex-col lg:flex-row gap-12 sm:gap-16 lg:gap-20 w-full items-start justify-between">
      {/* Left Column - Text Content */}
      <div className="max-w-3xl flex-1">
        {/* Philosophy Section */}
        <div className="mb-12 sm:mb-16 space-y-4 sm:space-y-6">
          <p className="text-white/80 font-light leading-[1.9] text-[14px] sm:text-[15px]" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
        ...
        {/* Background Section */}
        <div className="mb-12 sm:mb-16 border-l border-white/10 pl-4 sm:pl-6 space-y-4 sm:space-y-6">
          <p className="text-white/80 font-light leading-[1.9] text-[14px] sm:text-[15px]" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
        ...
        <div className="pt-10 sm:pt-12 border-t border-white/10">
          <p className="font-mono text-[9px] sm:text-[10px] tracking-[0.15em] uppercase text-white/30 mb-4 sm:mb-5">
            Beyond Code
          </p>
          <p className="text-white/80 font-light leading-[1.9] text-[13px] sm:text-[14px] italic" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
      ...
      {/* Right Column - Image */}
      <div className="w-full max-w-sm mx-auto sm:max-w-none sm:w-80 lg:w-96 flex-shrink-0">
        <div className="group lg:sticky lg:top-24">
          {/* Minimalist Frame */}
          <div className="border border-white/20 p-5 sm:p-5 bg-black/20">
